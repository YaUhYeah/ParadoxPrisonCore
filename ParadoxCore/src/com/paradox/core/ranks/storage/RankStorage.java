...
public class RankStorage {
	...
	public static Rank O = new Rank("O", 15, 80000, false, false);
	public static Rank P = new Rank("P", 16, 100000, false, false);
	public static Rank Q = new Rank("Q", 17, 250000, false, false);
	public static Rank R = new Rank("R", 18, 500000, false, false);
	public static Rank S = new Rank("S", 19, 750000, false, false);
	public static Rank T = new Rank("T", 20, 1000000, false, false);
	public static Rank U = new Rank("U", 21, 3000000, false, false);
	public static Rank V = new Rank("V", 22, 5000000, false, false);
	public static Rank W = new Rank("W", 23, 7500000, false, false);
	public static Rank X = new Rank("X", 24, 8000000, false, false);
	public static Rank Y = new Rank("Y", 25, 9000000, false, false);
	public static Rank Z = new Rank("Z", 26, 10000000, false, true);
}
